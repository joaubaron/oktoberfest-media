...
function setupUIElements() {
    ...
    if (claraText) {
        claraText.innerHTML = `Clara na Oktoberfest de <strong>2017</strong> a <strong>${currentYear}</strong>`;
    }
